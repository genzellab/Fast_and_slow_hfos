...
%% FAST PM VS BASE.
w=3;
%FP,FQ,labelconditions2,label1,s,w,win_size,same_nr_types,N,random_hfo,rand_first_run,tr
%(P,Q,labelconditions2,label1,s,w,win_size,same_nr_types,N,random_hfo,rand_first_run,tr)
% P=FP;
% Q=FQ;
...
% w=1; %Brain Area
%%
[n1]=plot_spectra_ripples_vs_hfos(P,Q,SP,SQ,labelconditions2,label1,same_nr_types,N,'Ripples','Slow HFOs')
%printing(['NewSpec_ripples_vs_slow_rat' num2str(Rat) '_' num2str(tr(2))])    
close all

[n2]=plot_spectra_ripples_vs_hfos(P,Q,FP,FQ,labelconditions2,label1,same_nr_types,N,'Ripples','Fast HFOs')
%printing(['NewSpec_ripples_vs_fast_rat' num2str(Rat) '_' num2str(tr(2))])    
close all
