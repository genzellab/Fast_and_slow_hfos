...
%Find PFC spindles
[spindle,SpinFreq,spin_duration,Mx_cortex,timeasleep,sig_cortex,Ex_cortex,...
    Sx_cortex]=gui_findspindlesZugaro(CORTEX,states,xx,multiplets,fn);
...
[spindle,SpinFreq,spin_duration,Mx_par,timeasleep,sig_par,Ex_par,...
    Sx_par]=gui_findspindlesZugaro(par,states,yy,multiplets,fn);
...
single_mx_par_val=vertcat(single_mx_par_val{:});
single_sx_par_val=vertcat(single_sx_par_val{:});
...
single_mx_cortex_val=vertcat(single_mx_cortex_val{:});
single_sx_cortex_val=vertcat(single_sx_cortex_val{:});
