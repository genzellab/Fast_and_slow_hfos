...
%             yticks([0:0.1:0.5])            
        ...
        if print_hist==1
            subplot(3,2,3)
%             xlim([0 30])
            histogram(z,10); title('Amplitude');xlabel('\muV');ylabel('Count')         
%             ylim([0 60])
%             yticks([0:10:60])
...
%             yticks([0:0.1:0.5])            
        ...
        if print_hist==1
            subplot(3,2,4)
%             xlim([0 0.5])
            histogram(l,10); title('Area under the curve');xlabel('AUC');ylabel('Count') 
%             ylim([0 50])
%             yticks([0:10:50])
...
%             yticks([0:0.1:0.5])
        ...
        if print_hist==1
            subplot(3,2,6)
%             xlim([0 45])
            histogram(p,10); title('Peak-to-peak amplitude');xlabel('\muV');ylabel('Count');   
%             ylim([0 70])
%             yticks([0:10:70])
